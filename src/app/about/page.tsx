  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-24 sm:px-8 font-sans text-zinc-950 bg-white" id="about-view">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
        ...
        {/* Overview */}
        <div className="group relative bg-white border border-zinc-200 rounded-md p-8 card-lift hover:border-zinc-300 transition-colors">
          <div className="relative z-10 flex items-center justify-center w-12 h-12 rounded-md bg-zinc-900 text-white mb-6 shadow-sm">
