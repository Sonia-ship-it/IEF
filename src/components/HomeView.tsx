...
export default function HomeView({
  ...
  return (
    <div className="font-sans text-zinc-900 bg-white" id="home-view">
      ...
      {/* ================================================================
          1. HERO SECTION — Side-by-side Layout (Text left, Image right)
          ================================================================ */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="max-w-2xl text-left animate-fade-up">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <button onClick={() => setView('shop')} className="btn-primary text-base px-8 py-4">
                  Explore Shop Catalogue
                  <ArrowRight className="h-5 w-5" />
                </button>
                <button onClick={() => setView('services')} className="btn-outline text-base px-8 py-4">
                  Technical Services
                </button>
              </div>
      ...
      {/* ================================================================
          2. CATEGORIES — Dot Grid Background
          ================================================================ */}
      ...
      {/* ================================================================
          4. HOW TO SHOP — Line Grid Background
          ================================================================ */}
...
function ProductCard({ product, isInWishlist, onProductClick, onAddToCart, onAddToWishlist }: ProductCardProps) {
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-md border border-zinc-200 bg-white card-lift shadow-sm hover:shadow-md transition-all">
      ...
      >
        ...
        {product.stock <= 8 && (
          <span className="absolute top-3 left-3 rounded-md bg-zinc-900 px-2.5 py-1 text-[10px] font-bold text-white uppercase tracking-wider shadow-sm">
            Low Stock
          </span>
        )}
        ...
        <button
          ...
          className={`absolute top-3 right-3 w-10 h-10 flex items-center justify-center rounded-md border shadow-sm transition-all duration-200 hover:scale-105 ${
            isInWishlist
